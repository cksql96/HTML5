...
$(document).ajaxStart(function (e){
    console.debug("***************************************************************************");
    console.debug("* (1) ajaxStart() invoked... [Ajax global event lifeCycle]");
    console.debug("***************************************************************************");
...
$(document).ajaxSend(function (e, XHR, settings) {
    console.debug("***************************************************************************");
    console.debug("* (2) ajaxSend(e, XHR, settings) invoked... [Ajax global event lifeCycle]");
    console.debug("***************************************************************************");
...
$(document).ajaxSuccess(function (e, XHR, settings) {
    console.debug("***************************************************************************");
    console.debug("* (3) ajaxSuccess(e, XHR, settings) invoked... [Ajax global event lifeCycle]");
    console.debug("***************************************************************************");
...
$(document).ajaxError(function (e, XHR, settings, error) {
    console.debug("***************************************************************************");
    console.debug("* (3) ajaxError(e, XHR, settings, error) invoked... [Ajax global event lifeCycle]");
    console.debug("***************************************************************************");
